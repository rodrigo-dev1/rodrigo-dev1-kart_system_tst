...
const rows = [
    pilot("X", { overtakes:{madeOverall:12}, start:{deltaOverall:7}, bestLap:{time:59,rankOverall:1}, leadership:{lapsLedOverall:12}, pace:{regularity:.1}, qualifying:{positionOverall:1}, result:{positionOverall:1} }),
    pilot("A", { overtakes:{madeOverall:8}, start:{gridPositionOverall:10,firstLapPositionOverall:5,deltaOverall:5}, bestLap:{time:59.5,rankOverall:2}, leadership:{lapsLedOverall:0}, pace:{regularity:.2}, qualifying:{positionOverall:3}, result:{positionOverall:4} }),
    pilot("B", { overtakes:{madeOverall:5}, start:{deltaOverall:1}, bestLap:{time:60,rankOverall:3}, leadership:{lapsLedOverall:0}, pace:{regularity:.3}, qualifying:{positionOverall:4}, result:{positionOverall:5} }),
    pilot("C", { overtakes:{madeOverall:2}, start:{deltaOverall:0}, bestLap:{time:61,rankOverall:4}, leadership:{lapsLedOverall:0}, pace:{regularity:.4}, qualifying:{positionOverall:5}, result:{positionOverall:6} })
];
...
assert.equal(highlights.leadership.leadership.lapsLedOverall, 0);
